package com.swf.app.homeIntroLogin;
...
import com.swf.app.tiles.TileItem;
import com.swf.app.tiles.TilesAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (logoutBtn != null) {
            logoutBtn.setOnClickListener(v -> {
                ...
                Intent intent = new Intent(HomePage.this, com.swf.app.homeIntroLogin.LoginPage.class);
        ...
        switch (label) {
            ...
            case "Doctor Info": {
                try {
                    ...
                    Intent intent = new Intent(this, com.swf.app.doctorInfo.DoctorInfoPage.class);
                    startActivity(intent);
                } catch (Exception e) {
